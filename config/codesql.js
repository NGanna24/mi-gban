...
-- =============================================================================
-- TABLES SIMPLIFIÉES POUR LES AGENTS
-- =============================================================================

-- 1. TABLE PRINCIPALE DES AGENTS (simplifiée)
CREATE TABLE IF NOT EXISTS AgentDemande (
    id_demande INT PRIMARY KEY AUTO_INCREMENT,
    id_utilisateur INT NOT NULL,
    
    -- Champs exacts du frontend React Native
    fullName VARCHAR(100) NOT NULL,
    ...
    -- JSON pour stocker directement les tableaux du frontend
    propertyTypes JSON NOT NULL,      -- ["Appartement", "Maison", ...]
    coverageAreas JSON NOT NULL,      -- ["Paris intra-muros", "Petite Couronne", ...]
...
CREATE TABLE IF NOT EXISTS AgentDocument (
    ...
    -- Un document par type par demande
...
-- 3. TABLE POUR LA VÉRIFICATION D'ÉLIGIBILITÉ (optionnelle mais utile)
