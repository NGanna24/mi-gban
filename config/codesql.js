...
CREATE TABLE IF NOT EXISTS Notification (
    ...
    metadata JSON NULL,  -- EXCELLENT : position logique après message
    type ENUM('reservation', 'paiement', 'message', 'systeme', 'like', 'commentaire', 'partage', 'nouvelle_propriete', 'nouveau_suiveur') DEFAULT 'systeme',
    est_lu BOOLEAN DEFAULT FALSE,
    date_creation DATETIME DEFAULT CURRENT_TIMESTAMP,
